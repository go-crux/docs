...
description: "A step-by-step explanation of the Crux attribution waterfall, covering the six data sources checked in sequence and how first-click and last-click attribution differ."
---
